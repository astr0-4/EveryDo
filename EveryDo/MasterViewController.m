...
//:(id)sender
{
    if (![self.addItemTextField.text isEqualToString:@""]) {
        ...
        toDoItem.itemTitle = self.addItemTextField.text;
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [[object valueForKey:@"itemTitle"] description];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"itemTitle" ascending:YES selector:@selector(caseInsensitiveCompare:)];
